  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        distraction: {
          DEFAULT: "hsl(var(--distraction))",
          light: "hsl(var(--distraction-light))",
          foreground: "hsl(var(--distraction-foreground))",
        },
        idle: {
          DEFAULT: "hsl(var(--idle))",
          light: "hsl(var(--idle-light))",
          foreground: "hsl(var(--idle-foreground))",
        },
        score: {
